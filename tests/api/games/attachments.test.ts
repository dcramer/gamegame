  ...
  describe('GET /api/games/:gameIdOrSlug/attachments', () => {
      ...
      await db.insert(attachments).values([
        {
          ...
          url: `/uploads/resources/${testResourceId}/attachments/${attachment1Id}.png`,
        ...
        },
        {
          ...
          url: `/uploads/resources/${testResourceId}/attachments/${attachment2Id}.jpeg`,
    ...
    it('should return attachments for game by ID', async () => {
      ...
      await db.insert(attachments).values({
        ...
        url: `/uploads/resources/${testResourceId}/attachments/${attachmentId}.png`,
      ...
      await db.insert(attachments).values([
        {
          ...
          url: `/uploads/resources/${testResourceId}/attachments/${attachment3Id}.png`,
        ...
        },
        {
          ...
          url: `/uploads/resources/${testResourceId}/attachments/${attachment2Id}.png`,
